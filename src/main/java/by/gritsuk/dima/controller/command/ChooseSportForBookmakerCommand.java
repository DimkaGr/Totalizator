...
public class ChooseSportForBookmakerCommand implements Command {
    @Override
    public ResponseContent execute(HttpServletRequest request) {
        ...
        try {
            ...
            responseContent.setRouter(new Router(Router.Type.FORWARD,"/WEB-INF/views/add_bet_page1.jsp"));
